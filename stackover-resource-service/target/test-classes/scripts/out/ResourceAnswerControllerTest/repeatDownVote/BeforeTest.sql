...
DELETE FROM reputation WHERE id IN (1, 100, 101);
...
-- Добавляем существующий downvote (используем колонку vote_type_answer с текстовым значением)
INSERT INTO votes_on_answers (id, user_id, answer_id, vote_type_answer, persist_date)
VALUES (1, 101, 100, 'DOWN', CURRENT_TIMESTAMP);

-- Добавляем репутацию за downvote
INSERT INTO reputation (id, author_id, sender_id, count, type, persist_date, answer_id)
VALUES (1, 100, 101, -5, 2, CURRENT_TIMESTAMP, 100);
